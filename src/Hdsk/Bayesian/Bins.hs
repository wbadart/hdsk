...
Description:  Utilities for binning categorical data
...
-- ^ /O(k n log n) where k is # of bins./ Map each number in a vector of
-- continueous data to a bin number according to its percentile (makes
-- even-width bins).
